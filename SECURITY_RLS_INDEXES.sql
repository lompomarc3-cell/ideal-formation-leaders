-- ================================================================
-- SCRIPT SÉCURITÉ + INDEXES — IFL Application
...
-- ============================================================
-- 3. INDEXES D'OPTIMISATION (performance 20+ users)
-- ============================================================
-- Questions (requêtes les plus fréquentes)
...
-- Profiles (login/recherche par téléphone)
...
-- correction_requests (auth + paiements)
