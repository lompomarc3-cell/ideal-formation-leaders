  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Préparez vos concours du Burkina Faso avec des milliers de QCM. Démo gratuite de 10 questions. Concours directs (14 dossiers) et professionnels (39 dossiers)." />
            ...
            <div className="max-w-lg mx-auto px-4 pt-5" style={{ background: '#FFF8F0' }}>
              ...
              <div className="mt-4 rounded-2xl p-4 flex items-center justify-between border-2 bg-white" style={{ borderColor: '#C4521A' }}>
                <div>
                  ...
                  <p className="text-gray-500 text-xs">Débloquer tous les 14 dossiers</p>
                </div>
                    ...
                    <div className="space-y-3">
                      <div className="rounded-2xl p-4 flex items-center gap-3" style={{ background: 'linear-gradient(135deg,#FFF0E8,#FFE4CC)' }}>
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-xs">14 dossiers – <strong style={{ color: '#C4521A' }}>
