...
const ORDRE_MAP = {
  ...
  professionnel: [
    ...
    { match: 'sant', ordre: 10 },
    { match: 'elevage', ordre: 10 },
    { match: '\u00e9levage', ordre: 10 },
    ...
    { match: 'douane', ordre: 14 },
    { match: 'imp\u00f4t', ordre: 15 },
    { match: 'impot', ordre: 15 },
    { match: 'travail', ordre: 15 },
    { match: 'enaref', ordre: 15 },
    { match: 'affaires \u00e9trang\u00e8res', ordre: 15 },
    { match: 'affaires etrangeres', ordre: 15 },
    { match: '\u00e9trang\u00e8re', ordre: 15 },
    { match: 'etrangere', ordre: 15 },
    { match: 'civil', ordre: 16 },
    { match: 'entra', ordre: 17 },
    { match: 'accomp', ordre: 18 },
  ]
}
...
function getCatIcon(nom, catType) {
  ...
  if (n.includes('affaires étrangères') || n.includes('affaires etrangeres') || n.includes('étrangère') || n.includes('etrangere')) return '🌍'
