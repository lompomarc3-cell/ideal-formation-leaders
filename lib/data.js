...
// ============================================================
// STRUCTURE FINALE – 17 Dossiers Concours Professionnels (ordre imposé)
// ============================================================
export const CATEGORIES_PRO = [
  { ordre: 1, nom: "Spécialités Vie scolaire (CASU-AASU)", icone: "🏫" },
  { ordre: 2, nom: "Actualités et culture générale", icone: "🌍" },
  { ordre: 3, nom: "Spécialités CISU/AISU/ENAREF", icone: "🏛️" },
  { ordre: 4, nom: "Inspectorat : IES", icone: "🔍" },
  { ordre: 5, nom: "Inspectorat : IEPENF", icone: "🔎" },
  { ordre: 6, nom: "CSAPÉ", icone: "🎓" },
  { ordre: 7, nom: "Agrégés", icone: "📜" },
  { ordre: 8, nom: "CAPES toutes options", icone: "📖" },
  { ordre: 9, nom: "Administrateur des hôpitaux", icone: "🏥" },
  { ordre: 10, nom: "Spécialités santé", icone: "💊" },
  { ordre: 11, nom: "Justice", icone: "⚖️" },
  { ordre: 12, nom: "Magistrature", icone: "👨‍⚖️" },
  { ordre: 13, nom: "Spécialités GSP", icone: "🛡️" },
  { ordre: 14, nom: "Spécialités police", icone: "👮" },
  { ordre: 15, nom: "Administrateur civil", icone: "📋" },
  { ordre: 16, nom: "Entraînement QCM", icone: "✏️" },
  { ordre: 17, nom: "Accompagnement final", icone: "🎯" }
]
