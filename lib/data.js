...
export const DEMO_QUESTIONS = [
  ...
  },
  {
    ...
    option_d: "17 régions",
    bonne_reponse: "D",
    explication: "Le Burkina Faso est officiellement passé de 13 à 17 régions le 2 juillet 2025. Cette réorganisation administrative, entérinée en Conseil des ministres, a créé quatre nouvelles régions : le Soum, la Sirba, la Tapoa et le Sourou. Toutes les régions ont par ailleurs reçu de nouveaux noms en langues nationales, abandonnant leurs anciennes appellations issues de l'époque coloniale. Une période transitoire de six mois a été décrétée pour la mise en œuvre complète de cette réforme."
  },
  {
    id: 'demo-9',
...
// ============================================================
// STRUCTURE FINALE – 14 Dossiers Concours Directs (ordre imposé)
// ============================================================
export const CATEGORIES_DIRECT = [
  ...
  { ordre: 9, nom: "Droit", icone: "⚖️" },
  { ordre: 10, nom: "Économie", icone: "💹" },
  { ordre: 11, nom: "Entraînement QCM", icone: "✏️" },
  { ordre: 12, nom: "Accompagnement final", icone: "🎯" },
  { ordre: 13, nom: "INTÉGRATION SANTÉ", icone: "🏥" },
  { ordre: 14, nom: "ARMÉE ET PARAMILITAIRE", icone: "🎖️" }
]

// ============================================================
// STRUCTURE FINALE – 39 Dossiers Concours Professionnels (36 payants + 3 bonus)
// ============================================================
export const CATEGORIES_PRO = [
  // ── Dossiers payants (1–36) ──
  { ordre: 1,  nom: "Spécialités Vie scolaire (CASU-AASU)", icone: "🏫" },
  { ordre: 2,  nom: "Spécialités CISU/AISU/ENAREF", icone: "🎪" },
  { ordre: 3,  nom: "Inspectorat : IES", icone: "🔍" },
  { ordre: 4,  nom: "Inspectorat : IEPENF", icone: "🔎" },
  { ordre: 5,  nom: "CSAPÉ", icone: "🎓" },
  { ordre: 6,  nom: "Agrégés", icone: "📜" },
  { ordre: 7,  nom: "CAPES toutes options", icone: "📖" },
  { ordre: 8,  nom: "Administrateur des hôpitaux", icone: "🏥" },
  { ordre: 9,  nom: "Spécialités santé", icone: "💊" },
  { ordre: 10, nom: "Justice", icone: "⚖️" },
  { ordre: 11, nom: "Magistrature", icone: "👨‍⚖️" },
  { ordre: 12, nom: "Spécialités GSP", icone: "🛡️" },
  { ordre: 13, nom: "Spécialités police", icone: "👮" },
  { ordre: 14, nom: "Administrateur civil", icone: "📋" },
  { ordre: 15, nom: "CAPÉ", icone: "🏅" },
  { ordre: 16, nom: "Inspecteur des Impôts", icone: "💰" },
  { ordre: 17, nom: "Contrôleur des Impôts", icone: "🧾" },
  { ordre: 18, nom: "ENAREF B&A (IFPBF)", icone: "🏛️" },
  { ordre: 19, nom: "Inspecteur du Travail", icone: "🔬" },
  { ordre: 20, nom: "Contrôleur du Travail", icone: "📂" },
  { ordre: 21, nom: "Technicien Supérieur d'Élevage et Santé Animale", icone: "🐄" },
  { ordre: 22, nom: "Ingénieur d'Élevage et Santé Animale", icone: "🐾" },
  { ordre: 23, nom: "Technicien Supérieur d'Agriculture", icone: "🌿" },
  { ordre: 24, nom: "Ingénieur en Agriculture", icone: "🚜" },
  { ordre: 25, nom: "Conseiller des Affaires Étrangères", icone: "🌐" },
  { ordre: 26, nom: "Douane : Contrôleur & Inspecteur", icone: "🛃" },
  // ── 🆕 7 NOUVEAUX dossiers (27–34 payants) ──
  { ordre: 27, nom: "AGENT SPÉCIALISÉ EN GRH", icone: "🧑‍💼" },
  { ordre: 28, nom: "ASSISTANT EN GRH", icone: "📝" },
  { ordre: 29, nom: "CONSEILLER EN GRH", icone: "💼" },
  { ordre: 30, nom: "Technicien Supérieur Géomètre et Agent", icone: "📐" },
  { ordre: 31, nom: "Ingénieur de Conception du Génie Rural (B1 à A1)", icone: "🌾" },
  { ordre: 32, nom: "Ingénieur de Conception en Hydraulique", icone: "💧" },
  { ordre: 33, nom: "GREFFIER, SECRÉTAIRE DE GREFFIER ET PARQUET", icone: "📑" },
  { ordre: 34, nom: "ENAREF CYCLE C", icone: "🎖️" },
  // ── 🆕 NOUVEAU dossier (35 payant) ──
  { ordre: 35, nom: "ADJOINT DE SECRÉTARIAT", icone: "✍️" },

  // ── 🆕 NOUVEAU dossier (36 payant) ──
  { ordre: 36, nom: "Certificat d'aptitude Pédagogique d'enseignement Technique (CAPET) option comptabilité et gestion", icone: "📘" },

  // ── 3 Dossiers BONUS (toujours à la fin) ──
  { ordre: 37, nom: "Actualités et culture générale", icone: "🌍" },
  { ordre: 38, nom: "Entraînement QCM", icone: "✏️" },
  { ordre: 39, nom: "Accompagnement final", icone: "🏆" }
]
